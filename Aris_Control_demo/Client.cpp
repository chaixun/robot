...
int OnControlCommandNeeded(Aris::Core::MSG &msg)
{
	...
	int cmd;
	cout<<"Commands:"<<endl;
	cout<<"1.PowerOff"<<endl<<"2.Stop"<<endl<<"3.Enable"<<endl<<"4.Running"<<endl<<"5.Gohome_1"<<endl<<"6.Gohome_2"<<endl<<"7.HOme2start_1"<<endl<<"8.Home2start_2"<<endl<<"9.Forward"<<endl<<"10.Backward"<<endl<<"11.Fast_Forward"<<endl<<"12.Fast_Backward"<<endl<<"13.Legup"<<endl<<"14.Turnleft"<<endl<<"15.TurnRight"<<endl;
